...
class JogoWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        if self.game_pane is None:
            raise RuntimeError("gamePane não encontrado no partida.ui (objectName deve ser 'gamePane')")
    ...
    # --- Loop do jogo ---
    def game_loop(self):
        """O ciclo principal do jogo, executado a cada frame."""
    ...
    def movimentar_jogador(self):
        """Controla a movimentação e disparo do jogador."""
    ...
    def movimentar_aliens(self):
        """Controla a movimentação horizontal e descida dos aliens."""
    ...
    def verificar_colisoes(self):
        """Verifica e trata colisões entre disparos, naves e barreiras."""
        disparos_remover = []
        aliens_remover = []
    ...
    def atualizar_vidas(self):
        """Atualiza a exibição do número de vidas do jogador."""
